"""RNG-state helpers shared by AFM04 checkpoint/resume code."""
...
try:
    import torch
except Exception:  # pragma: no cover - torch is available in normal AFM04 runs.
    torch = None  # type: ignore[assignment]


RNG_STATE_FORMAT = "afm04_rng_state_v1"
