...
SCRIPT_ORDER = [
    "plot_afm_kan_full_test_losses_04.py",
    "plot_afm_kan_full_test_grad_norm_04.py",
    "plot_afm_kan_full_test_q_init_04.py",
    "plot_afm_kan_full_test_recon_nn_04.py",
    "plot_afm_kan_full_test_preopt_rank_04.py",
    "plot_afm_kan_full_test_mech_04.py",
    "plot_afm_kan_full_test_state_x2dot_04.py",
    "plot_afm_kan_full_test_fcontact_traj_04.py",
    "plot_afm_kan_full_test_x1x3_traj_04.py",
    "plot_afm_kan_full_test_x2_x2dot_traj_04.py",
]

# Full-horizon rollout scripts are intentionally excluded from this runner.
...
def main() -> None:
    ...
    print("[done] AFM04 KAN full-test all visualizations generated")
