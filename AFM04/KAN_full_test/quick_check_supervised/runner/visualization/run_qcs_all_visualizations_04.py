...
SCRIPT_ORDER = [
    ...
    "plot_qcs_nn_error_04.py",
    "plot_qcs_x1x3_error_04.py",
    "plot_qcs_fts_fit_04.py",
]
...
def main() -> None:
    ...
    env.pop("HNODECB_AFM04_KFT_QCS_VIS_ALLOW_LOG_FALLBACK", None)
    ...
    print("[done] KFT quick-check supervised all visualizations generated")
