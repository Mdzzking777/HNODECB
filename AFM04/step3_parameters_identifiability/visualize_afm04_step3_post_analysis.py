"""Visualization-only entry for AFM04 step3 post-analysis results.

The numeric post-analysis runner writes tables only. This script is the only
CLI entry that writes the three AFM04 step3 post-analysis PNG figures.
"""
...
from post_analyze_afm04_step3_identifiability import (
    THIS_DIR,
    copy_latest,
    load_step3_result,
    log,
