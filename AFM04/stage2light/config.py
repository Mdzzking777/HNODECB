...
def default_config(repo_root: str | Path | None = None) -> Stage2LightConfig:
    ...
    output_root = repo_root / "AFM04" / "stage2light"
    ...
    return Stage2LightConfig(
        ...
        window_mode=os.environ.get("HNODECB_AFM04_STAGE2LIGHT_WINDOW_MODE", "stage2_w123").strip() or "stage2_w123",
        arch_window_us=_env_float("HNODECB_AFM04_STAGE2LIGHT_WINDOW_US", 5.0e-6),
        ...
        wpred_enabled=_env_bool("HNODECB_AFM04_STAGE2LIGHT_WPRED", False),
        train_wpred_enabled=_env_bool(
            "HNODECB_AFM04_STAGE2LIGHT_TRAIN_WPRED",
            _env_bool("HNODECB_AFM04_STAGE2LIGHT_WPRED", False),
        ),
        wpred_eps=_env_float("HNODECB_AFM04_STAGE2LIGHT_WPRED_EPS", 1.0e-10),
        epochs=max(1, _env_int("HNODECB_AFM04_STAGE2LIGHT_EPOCHS", 1000)),
        ...
        lr_adapt=_env_bool("HNODECB_AFM04_STAGE2LIGHT_LR_ADAPT", True),
        lr_min=lr_min,
        lr_max=lr_max,
        ...
        recent_val_early_stop=_env_bool("HNODECB_AFM04_STAGE2LIGHT_RECENT_VAL_EARLY_STOP", True),
        recent_val_window=max(1, _env_int("HNODECB_AFM04_STAGE2LIGHT_RECENT_VAL_WINDOW", 30)),
