...
Inherits Stage1 top candidates, then performs NN-only random search on one base candidate
(default rank 6), keeping ks/cs fixed.
=#
...
if !haskey(ENV, "HNODECB_STAGE1PLUS_GNN_TARGET")
  ENV["HNODECB_STAGE1PLUS_GNN_TARGET"] = "5e-10"
end
