#=
Quick inspector for afm_param_stage2_01.jld
...
path = "../step2a_hyperparameter_tuning/hyperparameter_tuning_second_stage/results_afm/afm_param_stage2_01.jld"
if !isfile(path)
...
for i in 1:topn
  ...
  println("Rank ", i, " -- loss=", @sprintf("%.4e", r.loss),
    ...
    " x3_obs=", @sprintf("%.4e", get(r, :x3_obs, NaN)),
