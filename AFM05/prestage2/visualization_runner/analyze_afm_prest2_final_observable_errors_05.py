...
DEFAULT_ARCHIVE_ROOT = REPO_ROOT / "AFM05" / "prestage2"
DEFAULT_CANDIDATES_PATH = DEFAULT_ARCHIVE_ROOT / "results" / "afm_prest2_05_candidates_b.pkl"
...
def write_txt(rows: list[dict[str, Any]], out_path: Path) -> None:
    ...
    with out_path.open("w", encoding="utf-8") as f:
        f.write("AFM05 prest2 final observable errors from saved viz payloads\n")
