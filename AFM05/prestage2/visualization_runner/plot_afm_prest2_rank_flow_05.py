...
PREST2_ROOT = REPO_ROOT / "AFM05" / "prestage2"
DEFAULT_DRIVER_LOG = PREST2_ROOT / "logs" / "log2_05_prest2_local_driver_20260427_101556.txt"
DEFAULT_LAYER_A_RESULT = PREST2_ROOT / "results" / "afm_prest2_05_top_mech_winners_a.pkl"
DEFAULT_FINAL_RESULT = PREST2_ROOT / "results" / "afm_prest2_05_candidates_b.pkl"
DEFAULT_OUT_DIR = PREST2_ROOT / "visualization"
DEFAULT_TOP_STAGE1 = 200
DEFAULT_TOP_NEWRANK = 100
DEFAULT_TOP_CANDIDATE = 10
...
def build_flow_plot(
    *,
    ...
    ax.axvline(30.0, color="#b9c0c7", linewidth=1.0, linestyle="--", zorder=0)

    ax.set_xlim(-5.5, 35.5)
    ax.set_ylim(0, ymax + 2)
    ax.set_xticks([0.0, 10.0, 30.0], labels=["0", "10", "30"])
    ax.set_xlabel("epochs")
    ax.set_ylabel("placements")
    ax.grid(True, axis="y", alpha=0.20)

    title = "AFM05 Gradient-Based Optimization Preliminary Test"
    ...
    ax.text(0.0, 1.01, "rank by stage 1 performance", transform=ax.get_xaxis_transform(), ha="center", va="bottom", fontsize=10)
    ax.text(10.0, 1.01, "Layer A", transform=ax.get_xaxis_transform(), ha="center", va="bottom", fontsize=10)
    ax.text(30.0, 1.01, "Layer B", transform=ax.get_xaxis_transform(), ha="center", va="bottom", fontsize=10)

    out_dir.mkdir(parents=True, exist_ok=True)
    out_path = out_dir / "afm_prest2_mech_winner_flow_05.png"
