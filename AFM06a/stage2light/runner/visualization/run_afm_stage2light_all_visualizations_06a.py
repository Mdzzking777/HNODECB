"""Generate the AFM06a counterpart of AFM04's formal all-visualizations set."""
...
def main() -> None:
    ...
    plot_final_bar_fts(context)
    plot_losses(context)
    plot_grad_norm(context)
    plot_reconstruction(context)
    plot_state_bar_fts_losses(context)
    plot_final_observables(context)
    print("[done] AFM06a stage2light all visualizations generated")
